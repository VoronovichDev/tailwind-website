...
function Card({ carInfo }) {
    return carInfo.id === 2 ? (
        <div className="w-full shadow-xl justify-between flex flex-col py-4 my-8 md:my-0 bg-slate-200 rounded-lg hover:scale-105 duration-300">
            <img
            ...
            <button
                className="bg-black w-[200px] rounded-md text-[#8cecff] font-medium my-6 mx-auto px-6 py-3"
                type="button"
            >
                Select
            </button>
